        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="<?php echo base_url(); ?>assets/images/banner1.jpg" width="500px" height="500px">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Lupa Password?</h1>
                    <p class="mb-4">Masukkan alamat e-mail anda!</p>
                  </div>
                  <form class="user" role="form" action="<?php echo base_url(); ?>sendemail/kirim" method="POST" enctype="multipart/form-data" >
                    ...
                    <button type="submit" name="lupa" class="btn btn-primary btn-user btn-block">
                      Reset Password
                    </button>
                  </form>
                  <hr>
