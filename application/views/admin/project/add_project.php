...
<hr>
<form role="form" action="<?php echo base_url(); ?>dashboard/saveproject" method="POST" enctype="multipart/form-data">
<div class="row"> <!-- row 1 -->
  ...
  <div class="col-lg-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Info Project</h6>
        </div>
        <div class="card-body">
          ...
          <div class="form-group row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Judul Project : </h6>
                <input type="text" class="form-control form-control-user" name="project_name" placeholder = "Judul Project" required>
              </div>
          </div>

          <div class="form-group row">
              <div class="col-sm-12 mb-3 mb-sm-0">
              <h6 class="m-0 font-weight-bold text-primary">Category Project : </h6>
          ...
          <div class="form-group row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Price (IDR): </h6>
                <input type="number" class="form-control form-control-user" name="price" placeholder = "Price Project" required>
              </div>
          </div>
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Pengaturan Project</h6>
        </div>
        <div class="card-body">
          <!-- Circle Buttons (Default) -->
...
<div class="row"> <!-- row 1 -->
  ...
  <div class="col-lg-12">
      <div class="card shadow mb-4">
        ...
        <!--
        <form role="form" action="<?php echo base_url(); ?>user/saveimg/<?php //echo $id_article ?>" method="POST" enctype="multipart/form-data">
        -->
        <div class="card-body">
          <!-- Circle Buttons (Default) -->
          ...
          <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="judul_img" id="exampleFirstName" placeholder="Title Gambar" required>
                </div>
            </div>
